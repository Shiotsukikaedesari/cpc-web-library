  ...
  methods: {
    ...
    initGui () {
      ...
      this.gui
        ...
        .onChange(data => {
          this.lightBox.hemisphereLight.position.x = data
        })
      this.gui
        .add(this.guiParam, 'positionY', -500, 500)
        .onChange(data => {
          this.lightBox.hemisphereLight.position.y = data
        })
      this.gui
      ...
      this.gui
        ...
        .onChange(data => {
          this.lightBox.hemisphereLight.rotation.x = Math.PI / 180 * data
        })
      this.gui
        .add(this.guiParam, 'rotationY', -180, 180)
        .onChange(data => {
          this.lightBox.hemisphereLight.rotation.y = Math.PI / 180 * data
        })
      this.gui
